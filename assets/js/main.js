(function (window, $) {
  ...
  function Menu() {
    if ($.exists('.hamburger')) {
      ...
      // Blokuojam scroll per pilno aukščio meniu
  ...
  function ms_home_slider() {
    if ($.exists('.swiper-container')) {
      ...
      // Jei turi .expanded-timeline__counter
  ...
  function Sort() {
    if ($.exists('.filtr-container')) {
      // data-filter reikšmes daryk kaip 'all', '1', 'value' ir pan.
  ...
  function InitGallery() {
    if ($.exists('#gallery')) {
      // #gallery viduje turi būti <a href="big.jpg"><img src="thumb.jpg"></a>
